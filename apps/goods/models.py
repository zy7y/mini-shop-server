...
class GoodsCategory(BaseModel):
    ...
    parent = fields.ForeignKeyField("models.GoodsCategory", related_name="subs", null=True, on_delete=fields.CASCADE)
...
class SPU(BaseModel):
    ...
    category1 = fields.ForeignKeyField("models.GoodsCategory", on_delete=fields.RESTRICT, related_name='cat1_spu')
    category2 = fields.ForeignKeyField("models.GoodsCategory", on_delete=fields.RESTRICT, related_name='cat2_spu')
    category3 = fields.ForeignKeyField("models.GoodsCategory", on_delete=fields.RESTRICT, related_name='cat3_spu')
